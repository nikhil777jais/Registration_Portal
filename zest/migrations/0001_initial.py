# Generated by Django 3.2.9 on 2021-11-19 06:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Pid',
            fields=[
                ('id', models.BigAutoField(auto_created=True, default=21000, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter Name', max_length=50)),
                ('college_name', models.CharField(choices=[('SRMS CET', 'SRMS CET'), ('SRMS CERT', 'SRMS CETR'), ('SRMS UNNAO', 'SRMS UNNAO'), ('SRMS IMS', 'SRMS IMS'), ('SRMS NURSING', 'SRMS NURSING'), ('OTHER', 'OTHER')], help_text='Select College', max_length=100)),
